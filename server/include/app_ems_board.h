...
typedef void (*app_ems_set_cb_t)(const ems_msg_type_t commamd, uint8_t position, int32_t data, uint8_t * const p_board_position);

typedef void (*app_ems_get_cb_t)(const ems_msg_type_t command, int32_t * const p_data);
